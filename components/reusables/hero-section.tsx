...
import { homeSvgs } from "../../app/pages/home-screen/homeSvgs"
...
const HeroSection = ({ variant = 'default', heroText, subText, imgSrc, imagAlt }: HeroSectionProps) => {
  return (
    <section aria-label="Hero" className="relative mb-7">
      ...
      <div className="relative h-svh md:h-[92vh] w-full">
        <Image
          src={imgSrc}
          alt={imagAlt || "An overhead spread of authentic Nigerian dishes — jollof rice, egusi, plantain and more — shared at a table"}
          fill
          priority
          sizes="100vw"
